...
- **Input Data**: It was similar as that of above trrained LR model.
...
- **Linear discriminant analysis**: One can try and perform dimensionality reduction on gene expressions or ccell viability feature using LDA and further train LR or SVM on the reduced dimensions.